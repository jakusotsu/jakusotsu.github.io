...
namespace REDBGRand.Server.Controllers
{
    ...
    public class CardController : ControllerBase
    {
        ...
        Card[] createOriginalSet()
        {
            ...
            original.Add(new Card("Combat Knife & Survival Knife", "https://static.wikia.nocookie.net/residentevil/images/6/66/We004.jpg", 0, "Weapon", "Premier", "", "Basic Knife"));
            ...
            original.Add(new Card("Handgun & Burst-Fire Handgun", "https://static.wikia.nocookie.net/residentevil/images/6/61/HandgunDBG.jpg", 0, "Weapon", "Premier", "", "Basic Handgun"));
        ...
        Card[] createAllianceSet()
        {
            ...
            alliance.Add(new Card("Great Ambition", "https://static.wikia.nocookie.net/residentevil/images/8/87/GreatambitionDBG.jpg", 0, "Action", "Alliance", "", "Partners"));
            ...
            alliance.Add(new Card("Archrival", "https://static.wikia.nocookie.net/residentevil/images/0/03/ArchrivalDBG.jpg", 0, "Action", "Alliance", "", "Partners"));
            ...
            alliance.Add(new Card("Partners", "https://static.wikia.nocookie.net/residentevil/images/c/cc/Ac-013_alliance_partners_partner_mod.jpg", 0, "Action", "Alliance", "", "Partners"));
            alliance.Add(new Card("Cornered", "https://static.wikia.nocookie.net/residentevil/images/1/1d/Ac-020_alliance_cornered_partner_mod.jpg", 0, "Action", "Alliance", "", "Partners"));
            alliance.Add(new Card("Star-Crossed Duo", "https://static.wikia.nocookie.net/residentevil/images/7/72/Starcrossedduo.png", 0, "Action", "Alliance", "", "Partners"));
            alliance.Add(new Card("Combat Knife & Survival Knife", "https://static.wikia.nocookie.net/residentevil/images/6/66/We004.jpg", 0, "Weapon", "Alliance", "", "Basic Knife"));
            alliance.Add(new Card("Handgun & Burst-Fire Handgun", "https://static.wikia.nocookie.net/residentevil/images/6/61/HandgunDBG.jpg", 0, "Weapon", "Alliance", "", "Basic Handgun"));
        ...
        Card[] createOutBreakSet()
        {
            ...
            outbreak.Add(new Card("Injection", "https://static.wikia.nocookie.net/residentevil/images/e/e9/Ac-026_outbreak_injection_infection_mod.jpg", 0, "Action", "Outbreak", "", "Infection"));
            outbreak.Add(new Card("Wesker's Secret", "https://static.wikia.nocookie.net/residentevil/images/a/a2/Ac-025_outbreak_weskers_secret_infection_mod.jpg", 0, "Action", "Outbreak", "", "Infection"));
            ...
            outbreak.Add(new Card("By Any Means Neccesary", "https://static.wikia.nocookie.net/residentevil/images/c/c4/Ac-027_outbreak_by_any_means_necessary_infection_mod.jpg", 0, "Action", "Outbreak", "", "Infection"));
            outbreak.Add(new Card("Power of the t-Virus ", "https://static.wikia.nocookie.net/residentevil/images/1/14/Outbreak_card_-_Power_of_the_t-Virus_AC-023.jpeg", 0, "Action", "Outbreak", "", "Infection"));
            outbreak.Add(new Card("Standard Sidearm & Samurai Edge", "https://static.wikia.nocookie.net/residentevil/images/1/1d/Standard-Sidearm.jpg", 0, "Weapon", "Outbreak", "", "Standard Handgun"));
        ...
        Card[] createMercenariesSet()
        {
            ...
            mercenaries.Add(new Card("Custom Standard Sidearm", "https://static.wikia.nocookie.net/residentevil/images/d/d2/Mercenaries_card_-_Custom_Standard_Sidearm.jpeg", 0, "Weapon", "Mercenaries", "", "Basic Handgun"));
            mercenaries.Add(new Card("Reliable Blade", "https://static.wikia.nocookie.net/residentevil/images/3/3d/Mercenaries_card_-_Reliable_Blade.jpeg", 0, "Weapon", "Mercenaries", "", "Basic Knife"));
            ...
            mercenaries.Add(new Card("Coup de Grace", "https://static.wikia.nocookie.net/residentevil/images/1/1d/Mercenaries_card_-_Coup_de_Grace.jpeg", 0, "Action", "Mercenaries", "", "Skills"));
            ...
            mercenaries.Add(new Card("Battle Hardened", "https://static.wikia.nocookie.net/residentevil/images/3/3d/Ac-049_mercenaries_battle_hardened_skill_mod.jpg", 0, "Action", "Mercenaries", "", "Skills"));
            ...
            mercenaries.Add(new Card("Custom Full-Bore Machine Gun", "https://static.wikia.nocookie.net/residentevil/images/e/ee/Mercenaries_card_-_Custom_Full-Bore_Machine_Gun.jpeg", 0, "Weapon", "Mercenaries", "", "Skills"));
            mercenaries.Add(new Card("Custom Lightning Hawk", "https://static.wikia.nocookie.net/residentevil/images/3/3d/Mercenaries_card_-_Custom_Lightning_Hawk.jpeg", 0, "Weapon", "Mercenaries", "", "Skills"));
            mercenaries.Add(new Card("Custom Bolt-Action Rifle", "https://static.wikia.nocookie.net/residentevil/images/4/4d/Mercenaries_card_-_Custom_Bolt-Action_Rifle.jpeg", 0, "Weapon", "Mercenaries", "", "Skills"));
        ...
        public IEnumerable<Card> Get()
        {
            ...
            Card[] subArray = array.Take(12).ToArray();
            return subArray;
        }
        ...
        public IEnumerable<Card> GetFilteredCards([FromBody] Filters filters)
        {
            try
            {
                var combinedArray = new Card[][] {
                    createOriginalSet(),
                    createAllianceSet(),
                    createOutBreakSet(),
                    createNightmareSet(),
                    createMercenariesSet()
                }.SelectMany(set => set).ToArray();
                Func<Card, bool> setComparator = (Card card) =>
                filters.includeBase && card.Set == "Premier" ||
                ...
                Func<Card, bool> exclusionComparator = (Card card) =>
                !((filters.excludeInfection && card.Subtype == "Infection") ||
                (filters.excludePartners && card.Subtype == "Partners") ||
                (filters.excludeSkills && card.Subtype == "Skills"));

                var rnd = new Random();
                var setFilteredArray = combinedArray.Where(setComparator).Where(exclusionComparator).OrderBy(x => rnd.Next());
                var itemFilteredArray = setFilteredArray.Where(card => card.Type == "Item").OrderBy(x => rnd.Next()).GroupBy(card => card.Name).Select(y => y.First()).Take(int.Parse(filters.numItems));
                var actionFilteredArray = setFilteredArray.Where(card => card.Type == "Action").OrderBy(x => rnd.Next()).Take(int.Parse(filters.numActions));
                var weaponFilteredArray = setFilteredArray.Where(card => card.Type == "Weapon").OrderBy(x => rnd.Next()).Take(int.Parse(filters.numWeapons));
                var finalArray = itemFilteredArray.Concat(actionFilteredArray).Concat(weaponFilteredArray).OrderBy(x => rnd.Next()).Take(12).OrderBy(card => card, new PriorityComparator());
                return finalArray;
            }
            catch (Exception ex)
            {
    ...
    public struct Card
    {
        public Card(string name, string filepath, int cost, string type, string set, string description, string subtype)
        {
            Name = name;
            Type = type;
            Cost = cost;
    ...
    public class PriorityComparator : IComparer<Card>
    {
            ...
            Dictionary<string, int> priorityOrder = new Dictionary<string, int>
        {
            ...
            var priorityX = priorityOrder.ContainsKey(x.Type) ? priorityOrder[x.Type] : int.MaxValue;
            var priorityY = priorityOrder.ContainsKey(y.Type) ? priorityOrder[y.Type] : int.MaxValue;
